...
import com.chinatelecom.ctsi.workhelper.listener.SwipeGestureListener;
import com.chinatelecom.ctsi.workhelper.listener.SwipeGestureListener.OnFlingListener;

public class SwipeViewFlipper  extends ViewFlipper implements OnFlingListener {
	    ...
	    public SwipeViewFlipper(Context context, AttributeSet attrs) {
	        super(context, attrs);
	    }
	    ...
	    public void setOnViewFlipperListener(OnViewFlipperListener mOnViewFlipperListener) {
	        ...
	        //初始化自定义滑动事件监听器
	        SwipeGestureListener myGestureListener = new SwipeGestureListener();
	        //绑定自定义的滑动监听器
