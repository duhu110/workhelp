...
import com.chinatelecom.ctsi.workhelper.helper.DutyInfoHelper.NewDutyListener;
...
public class SharedDutyHelper {
	...
	public static NewSharedDutyListener listener;
	public interface NewSharedDutyListener{
		public void OnNewSharedDuty(SharedDuty info);
